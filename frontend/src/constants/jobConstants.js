...
export const JOB_CREATE_CV_REQUEST = 'JOB_CREATE_CV_REQUEST'
export const JOB_CREATE_CV_SUCCESS = 'JOB_CREATE_CV_SUCCESS'
export const JOB_CREATE_CV_FAIL = 'JOB_CREATE_CV_FAIL'
export const JOB_CREATE_CV_RESET = 'JOB_CREATE_CV_RESET'

export const JOB_TOP_REQUEST = 'JOB_TOP_REQUEST'
export const JOB_TOP_SUCCESS = 'JOB_TOP_SUCCESS'
export const JOB_TOP_FAIL = 'JOB_TOP_FAIL'
